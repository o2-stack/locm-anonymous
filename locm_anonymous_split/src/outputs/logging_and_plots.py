...
def plot_round_comparison(all_round_results, fname):
    ...
    vb50 = [float(np.mean(r["VB"][-50:])) for r in all_round_results]
    ...
    ax2 = ax1.twinx()
    ax2.plot(x, vb50, marker="s", color="tab:red", label="Final 50 VBias")
    ax2.set_ylabel("VBias", color="tab:red")
